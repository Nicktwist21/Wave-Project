const main = async () => {
    ...
    const waveContract = await waveContractFactory.deploy(); //What's happening here is Hardhat will create a local Ethereum network for us, but just for this contract
